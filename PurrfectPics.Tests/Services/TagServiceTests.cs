...
namespace PurrfectPics.Tests.Services
{
    public class TagServiceTests
    {
        ...
        {
            // Arrange
            var tags = new List<Genre>
            {
                new Genre { Id = 1, Name = "Tag1" },
                new Genre { Id = 2, Name = "Tag2" }
            };
        ...
        public async Task GetPopularTagsAsync_ReturnsPopularTagsFromRepository()
        {
            ...
            var tags = new List<Genre>
            {
                new Genre { Id = 1, Name = "Popular" },
                new Genre { Id = 2, Name = "LessPopular" }
            };
        ...
        {
            // Arrange
            var tag = new Genre { Id = 1, Name = "Test" };
        ...
        {
            // Arrange
            var existingTag = new Genre { Id = 1, Name = "Existing" };
            ...
            _mockRepo.Verify(x => x.AddAsync(It.IsAny<Genre>()), Times.Never);
        }
        ...
        {
            // Arrange
            _mockRepo.Setup(x => x.GetByNameAsync("New")).ReturnsAsync((Genre)null);
            _mockRepo.Setup(x => x.AddAsync(It.IsAny<Genre>()))
                .ReturnsAsync(new Genre { Id = 1, Name = "New" });
            ...
            _mockRepo.Verify(x => x.AddAsync(It.Is<Genre>(t => t.Name == "New")), Times.Once);
        }
